...
Sections = (function() {
  function Sections() {
    ...
    for (i = _i = _ref2 = window.PaperSections.data.sectionscount; _ref2 <= 0 ? _i <= 0 : _i >= 0; i = _ref2 <= 0 ? ++_i : --_i) {if (window.CP.shouldStopExecution(1)){break;}
...
window.CP.exitedLoop(1);
  ...
  Sections.prototype.update = function() {
    ...
    _ref1 = this.contents;
    _results = [];
    for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {if (window.CP.shouldStopExecution(2)){break;}
      it = _ref1[i];
...
window.CP.exitedLoop(2);
  ...
  Sections.prototype.popSection = function(n) {
    ...
    TWEEN.removeAll();
    _results = [];
    for (i = _i = _ref1 = this.contents.length - 1; _ref1 <= 0 ? _i <= 0 : _i >= 0; i = _ref1 <= 0 ? ++_i : --_i) {if (window.CP.shouldStopExecution(3)){break;}
...
window.CP.exitedLoop(3);
  ...
  Sections.prototype.teardown = function() {
    ...
    _results = [];
    for (i = _i = _ref1 = this.contents.length - 1; _ref1 <= 0 ? _i <= 0 : _i >= 0; i = _ref1 <= 0 ? ++_i : --_i) {if (window.CP.shouldStopExecution(4)){break;}
